...
class PartnerForm(Ui_Partner_Form, QWidget):
    ...
    def copyAddress(self):
        ...
        self.shipment_address3_line_edit.setText(self.billing_address3_line_edit.text())
    ...
    def formToPartner(self):
        ...
        self.partner.billing_line3 = self.billing_address3_line_edit.text()
        ...
        self.partner.shipping_line3 = self.shipment_address3_line_edit.text()
    ...
    def partnerToForm(self):
        ...
        self.billing_address3_line_edit.setText(self.partner.billing_line3)
        ...
        self.shipment_address3_line_edit.setText(self.partner.shipping_line3)
