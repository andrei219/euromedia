...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.layoutWidget_2.setGeometry(QtCore.QRect(50, 150, 200, 29))
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(800, 80, 171, 91))
        ...
        self.incoterms.setGeometry(QtCore.QRect(810, 40, 51, 22))
        ...
        self.label_29.setGeometry(QtCore.QRect(733, 40, 62, 16))
        ...
        self.label_24.setGeometry(QtCore.QRect(881, 38, 33, 16))
        self.label_24.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_24.setObjectName("label_24")
        self.agent = QtWidgets.QComboBox(self.header)
        self.agent.setGeometry(QtCore.QRect(920, 40, 191, 22))
        ...
        self.external.setGeometry(QtCore.QRect(390, 160, 181, 20))
        self.external.setObjectName("external")
        self.label_4 = QtWidgets.QLabel(self.header)
        self.label_4.setGeometry(QtCore.QRect(270, 161, 91, 20))
        self.label_4.setObjectName("label_4")
        self.label_33 = QtWidgets.QLabel(self.header)
        self.label_33.setGeometry(QtCore.QRect(250, 190, 121, 27))
        ...
        self.shipping_address.setGeometry(QtCore.QRect(390, 190, 481, 27))
        ...
        self.lines_view.setSelectionMode(QtWidgets.QAbstractItemView.ExtendedSelection)
        ...
        self.insert.setGeometry(QtCore.QRect(948, 538, 101, 28))
        self.insert.setObjectName("insert")
        self.delete_ = QtWidgets.QPushButton(Form)
        self.delete_.setGeometry(QtCore.QRect(1066, 538, 93, 28))
        ...
        self.note.setGeometry(QtCore.QRect(990, 830, 251, 81))
        ...
        self.create_line.setGeometry(QtCore.QRect(30, 870, 631, 91))
        ...
        self.stock_message.setGeometry(QtCore.QRect(1002, 682, 231, 91))
        self.stock_message.setText("")
        self.stock_message.setObjectName("stock_message")
        self.layoutWidget_5 = QtWidgets.QWidget(Form)
        self.layoutWidget_5.setGeometry(QtCore.QRect(690, 910, 201, 145))
        ...
        self.subtotal = QtWidgets.QLineEdit(self.layoutWidget_5)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.ptax = QtWidgets.QLineEdit(self.layoutWidget_5)
        self.ptax.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.ptax.setReadOnly(True)
        self.ptax.setObjectName("ptax")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.ptax)
        ...
        self.cn = QtWidgets.QLineEdit(self.layoutWidget_5)
        self.cn.setObjectName("cn")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.cn)
        ...
        self.pending = QtWidgets.QLineEdit(self.layoutWidget_5)
        self.pending.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.pending.setReadOnly(True)
        self.pending.setObjectName("pending")
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.pending)
        ...
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.label_38)
        self.total = QtWidgets.QLineEdit(self.layoutWidget_5)
        self.total.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.total.setReadOnly(True)
        self.total.setObjectName("total")
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.total)
        self.splitter = QtWidgets.QSplitter(Form)
        self.splitter.setGeometry(QtCore.QRect(460, 540, 431, 16))
        self.splitter.setOrientation(QtCore.Qt.Horizontal)
        self.splitter.setObjectName("splitter")
        self.quantity_label = QtWidgets.QLabel(self.splitter)
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Edit Proforma"))
        ...
        self.label_4.setText(_translate("Form", "External Doc.:"))
        self.label_33.setText(_translate("Form", "Shipping Addr:"))
        ...
        self.tax.setItemText(1, _translate("Form", "21"))
...
" In Invoice"))
        ...
        self.label_36.setText(_translate("Form", "Subtotal:"))
        self.label_37.setText(_translate("Form", "Tax:"))
