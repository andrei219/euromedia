...
class JournalModel(BaseTable, QtCore.QAbstractTableModel):

	DATE, DESCRIPTION, TYPE, AMOUNT, BALANCE, AUTOGENERATED = 0, 1, 2, 3, 4, 5

	def __init__(self):
		super().__init__()
		self._headerData = ['Date', 'Description', 'Type', 'Amount', 'Balance', 'Autogenerated']
		self.name = '_data'
		query = (
			select
		)
