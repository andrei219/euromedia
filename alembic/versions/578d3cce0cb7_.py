...
Revision ID: 578d3cce0cb7
Revises: 
Create Date: 2022-06-13 19:09:10.692679
...
def upgrade():
    ...
    op.alter_column('sale_proformas', 'credit_amount',
               ...
               type_=sa.Float(precision=32),
               existing_nullable=True)
    op.add_column('wh_incoming_rma_lines', sa.Column('public_condition', sa.String(length=50), nullable=True))
...
def downgrade():
    ...
    op.alter_column('wh_incoming_rma_lines', 'price',
               ...
               existing_nullable=False)
    op.drop_column('wh_incoming_rma_lines', 'public_condition')
    op.alter_column('sale_proformas', 'credit_amount',
               existing_type=sa.Float(precision=32),
               type_=mysql.DOUBLE(asdecimal=True),
               existing_nullable=True)
