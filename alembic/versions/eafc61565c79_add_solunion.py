...
Revision ID: eafc61565c79
Revises: dfa58a180dc3
Create Date: 2024-05-16 14:42:45.586942
...
revision = 'eafc61565c79'
down_revision = 'dfa58a180dc3'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.alter_column('sale_expenses', 'amount',
               ...
               type_=sa.Float(precision=32),
               existing_nullable=False)
    op.add_column('sale_invoices', sa.Column('solunion', sa.Integer(), nullable=False))
...
def downgrade() -> None:
    ...
    op.alter_column('sale_payments', 'amount',
               ...
               type_=mysql.DOUBLE(asdecimal=True),
               existing_nullable=False)
    op.drop_column('sale_invoices', 'solunion')
    op.alter_column('sale_expenses', 'amount',
               existing_type=sa.Float(precision=32),
               type_=mysql.DOUBLE(asdecimal=True),
               existing_nullable=False)
