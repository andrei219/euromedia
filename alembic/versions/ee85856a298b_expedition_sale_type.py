"""expedition_sale_type

Revision ID: ee85856a298b
Revises: a0bc931e9d75
Create Date: 2022-04-07 14:13:35.922312
...
revision = 'ee85856a298b'
down_revision = 'a0bc931e9d75'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('agents', 'fixed_perpiece',
               ...
               type_=sa.Float(precision=32),
               existing_nullable=False)
    op.add_column('expeditions', sa.Column('from_sale_type', sa.Integer(), nullable=False))
...
def downgrade():
    ...
    op.alter_column('partner_documents', 'document',
               ...
               type_=mysql.LONGBLOB(),
               existing_nullable=True)
    op.drop_column('expeditions', 'from_sale_type')
    op.alter_column('agents', 'fixed_perpiece',
               existing_type=sa.Float(precision=32),
               type_=mysql.DOUBLE(asdecimal=True),
               existing_nullable=False)
