"""remove bad unique constrant on account

Revision ID: 07d9f66c8b05
Revises: 6a919bf2ad0a
Create Date: 2023-03-25 11:45:42.785596
...
revision = '07d9f66c8b05'
down_revision = '6a919bf2ad0a'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.drop_index('related_type_id_unique', table_name='accounts')
...
def downgrade() -> None:
    ...
    op.alter_column('advanced_lines', 'price',
               ...
               type_=mysql.DOUBLE(asdecimal=True),
               existing_nullable=True)
    op.create_index('related_type_id_unique', 'accounts', ['related_type', 'related_id'], unique=False)
    # ### end Alembic commands ###
