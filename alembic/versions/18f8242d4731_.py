...
Revision ID: 18f8242d4731
Revises: de8a86cb2efd
Create Date: 2022-11-21 11:59:09.683724
...
revision = '18f8242d4731'
down_revision = 'de8a86cb2efd'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('sale_expenses', 'amount',
               ...
               type_=sa.Float(precision=32),
               existing_nullable=False)
    op.drop_constraint('sale_invoices_ibfk_1', 'sale_invoices', type_='foreignkey')
...
def downgrade():
    ...
    op.alter_column('sale_payments', 'amount',
               ...
               type_=mysql.DOUBLE(asdecimal=True),
               existing_nullable=False)
    op.add_column('sale_invoices', sa.Column('parent_id', mysql.INTEGER(), autoincrement=False, nullable=True))
    op.create_foreign_key('sale_invoices_ibfk_1', 'sale_invoices', 'sale_invoices', ['parent_id'], ['id'])
    op.alter_column('sale_expenses', 'amount',
               existing_type=sa.Float(precision=32),
               type_=mysql.DOUBLE(asdecimal=True),
               existing_nullable=False)
