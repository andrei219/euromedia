...
Revision ID: 16f504868f7a
Revises: 
Create Date: 2022-07-13 16:42:12.198644
...
def upgrade():
    ...
    op.alter_column('purchase_proformas', 'credit_amount',
               ...
               type_=sa.Float(precision=32),
               existing_nullable=True)
    op.add_column('receptions', sa.Column('auto', sa.Boolean(), nullable=False))
...
def downgrade():
    ...
    op.alter_column('sale_documents', 'document',
               ...
               existing_nullable=True)
    op.drop_column('receptions', 'auto')
    op.alter_column('purchase_proformas', 'credit_amount',
               existing_type=sa.Float(precision=32),
               type_=mysql.DOUBLE(asdecimal=True),
               existing_nullable=True)
