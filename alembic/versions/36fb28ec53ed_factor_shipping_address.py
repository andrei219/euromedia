"""factor shipping address

Revision ID: 36fb28ec53ed
Revises: 72aa702cb9ec
Create Date: 2023-06-26 12:08:26.900623
...
revision = '36fb28ec53ed'
down_revision = '72aa702cb9ec'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    sa.Column('line2', sa.String(length=50), nullable=False),
