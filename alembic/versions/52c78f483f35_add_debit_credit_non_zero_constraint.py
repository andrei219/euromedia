"""add debit credit non zero constraint

Revision ID: 52c78f483f35
Revises: c3d9e8de64b9
Create Date: 2023-03-23 10:40:41.237157
...
revision = '52c78f483f35'
down_revision = 'c3d9e8de64b9'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.alter_column('advanced_lines', 'free_description',
    ...
    op.alter_column('sale_payments', 'rate',
               ...
               type_=sa.Float(precision=32),
               existing_nullable=False)
    op.alter_column('sale_proforma_lines', 'description',
               existing_type=mysql.VARCHAR(length=255),
